...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitBtn(View view){
        ...
        if(datasource.equals("Uttara") && destination.equals("Mirpur")){
            ...
            text.setText("Available Bus:\n1]Jabal-e-Noor: cost 30 taka\n2]Projapoti: cost 30 taka\n3]Konok: cost 30 taka");
        }
        else if(datasource.equals("Mirpur") && destination.equals("Uttara")){
            TextView text = (TextView) findViewById(R.id.Output);
            text.setText("Available Bus:\n1]Jabal-e-Noor: cost 30 taka\n2]Projapoti: cost 30 taka\n3]Konok: cost 30 taka");
        }
        else
        {
            TextView text = (TextView) findViewById(R.id.Output);
            text.setText("No possible way in the list");
        }
    }
